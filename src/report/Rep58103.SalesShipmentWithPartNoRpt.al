/// <summary>
/// Report SalesShipmentWithPartNoRpt (ID 58103).
/// </summary>
report 58103 "SalesShipmentWithPartNoRpt"
{
    DefaultLayout = RDLC;
    RDLCLayout = './layout/SalesShipment.rdl';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(SalesShptLine; "Integer")
                    {
                        ...
                        column(TempSalesShipmentLinePartNo; TempSalesShipmentLine."Part No.")
                        {
                        }
